...
def test_sudoku():
    """ This checks the Sudoku solution for my own internal test"""
...
def test_naked_twins():
    ...
    for i in range(2):
        print('\nSolution ', i)
        display(possible_solutions_1[i])
        


    after_naked_twins = before_naked_twins_1.copy()
    after_naked_twins = naked_twins(before_naked_twins_1)
    print('\n\nafter naked twins')
    display(after_naked_twins)
    print(before_naked_twins_1==after_naked_twins)
